...
describe('UsersController', () => {
  ...
  describe('findOne', () => {
    ...
    it('should propagate NotFoundException', async () => {
      ...
      expect(usersController.findOne('uuid-1')).rejects.toThrow(
        NotFoundException,
      );
    });
  });
  ...
  describe('update', () => {
    ...
    it('should propagate NotFoundException', async () => {
      ...
      expect(
        usersController.update('uuid-1', mockTokenPayloadDto, {
          name: 'Robson',
        }),
    ...
    it('should propagate ForbiddenException', async () => {
      ...
      expect(
        usersController.update('uuid-5', mockTokenPayloadDto, {
          name: 'Ricardo',
        }),
  ...
  describe('remove', () => {
    ...
    it('should propagate NotFoundException', async () => {
      ...
      expect(
        usersController.remove('uuid-1', mockTokenPayloadDto),
      ).rejects.toThrow(NotFoundException);
    });
    ...
    it('should propagate ForbiddenException', async () => {
      ...
      expect(
        usersController.remove('uuid-5', mockTokenPayloadDto),
      ).rejects.toThrow(ForbiddenException);
    });
  });
});
